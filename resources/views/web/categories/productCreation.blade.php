...
<div class="mx-5 my-3 h2">
    <a href="{{ route('home') }}" class="text-decoration-none fa-solid fa-circle-arrow-left"></a>
</div>
        ...
        <div class="col-auto" style="width: 300px;">
            <div class="card">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <a href="{{ route('subcategories.getSubcategoriesByCategory', $row->id) }}"><i class="fa-solid fa-arrow-right"></i></a>
